...
<div class="container" style="margin-top:30px">
    <center><h3 style="color: green; margin-top: 5px">Editar Produto</h3></center>
</div>
            ...
            <div id="login-column" class="col-md-6">
                <div id="login-box" class="col-md-12">
                    <form id="cadastro-produto-form" class="form" action="/" method="post">
                        ...
                        <div class="form-group">
                            <br/>
                            <center><input type="submit" name="submit" class="btn btn-success btn-md" style="margin-top: 10px;" value="Editar Produto"/></center>
                        </div>
                    </form>
                </div>
            </div>
